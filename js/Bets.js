...
$.getJSON("https://blockchain.info/multiaddr?cors=true&api_code=0fe3c82d-156d-405e-b8d4-eff695003036&active="+addresses_query, function (data) {
	...
	var bet_a = (total_balance_candidates / balance_a * profit) / (6 / 100 * 40.3);
	var bet_b = (total_balance_candidates / balance_b * profit) / (6 / 100 * 30.2);
	var bet_c = (total_balance_candidates / balance_c * profit) / (6 / 100 * 20.3);
	var bet_d = (total_balance_candidates / balance_d * profit) / (6 / 100 * 2.8);
	var bet_e = (total_balance_candidates / balance_e * profit) / (6 / 100 * 3);
